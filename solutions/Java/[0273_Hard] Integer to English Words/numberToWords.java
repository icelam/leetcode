class Solution {
  ...
  private static String[] multipleOfTenNumbers = new String[] {"Twenty", "Thirty", "Forty", "Fifty", "Sixty", "Seventy", "Eighty", "Ninety", "Hundred"};
    ...
    while (num > 0) {
      ...
      if (currentPart > 0) {
        ...
        if (remainingDigits > 0 && remainingDigits < 20) {
          ...
          builder.insert(0, " ");
          builder.insert(0, multipleOfTenNumbers[remainingDigits / 10 - 2]);
        }
